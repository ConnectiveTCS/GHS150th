<div class="project-card bg-slate-950 rounded-md p-4 sm:p-6" data-category="{{ strtolower($card->status ?? 'current') }}">
    <div class="flex flex-col md:flex-row p-4 rounded-lg">
        <div class="flex flex-col">
            ...
            <img src="/storage/{{ $card->image }}" alt="Garden Revival"
                class="w-full md:w-1/3 h-auto md:h-[400px] rounded-lg">
        </div>
