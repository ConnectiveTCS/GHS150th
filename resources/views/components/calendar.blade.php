...
<div class="calendar-container w-full text-black">
    ...
    <div id="eventDetails" class="mt-8 bg-white rounded-lg p-6 shadow-lg hidden">
        ...
        <div id="eventGallery" class="mb-6 hidden">
            ...
            <div class="relative">
                <!-- Main Image Display -->
                <div id="mainImageContainer" class="w-full overflow-hidden rounded-lg mb-4 cursor-pointer">
    ...
    <div id="imageLightbox" class="fixed inset-0 bg-black bg-opacity-90 z-50 hidden flex items-center justify-center">
        <div class="relative max-w-4xl w-full mx-auto">
            ...
            <img id="lightboxImage" src="" alt="Full size image" class="max-w-full max-h-[90vh] mx-auto">
        </div>
    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        mainImageContainer.addEventListener('click', function() {
            // Set lightbox image to the current main image source
