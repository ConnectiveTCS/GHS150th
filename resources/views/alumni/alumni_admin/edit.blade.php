        ...
        <form action="{{ route('alumni.update', $alumni->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div id="profile_picture_container" class="mb-4">
                <img id="image-preview"
                    src="{{ $alumni->profile_picture ? asset('storage/' . $alumni->profile_picture) : 'https://upload.wikimedia.org/wikipedia/commons/7/7c/Profile_avatar_placeholder_large.png' }}"
            ...
            <div class="mb-4">
                ...
                <input type="text" id="id_number" name="id_number" maxlength="13"
                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                    value="{{ $alumni->id_number }}">
            </div>
            <div class="mb-4">
                <label for="bio" class="block text-sm font-medium text-gray-700">Bio</label>
                <textarea id="bio" name="bio"
                    class="mt-1 block min-h-[250px] w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">{{ $alumni->bio }}</textarea>
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                <label for="class_of" class="block text-sm font-medium text-gray-700">Class Of<span
                        class="text-red-500">*</span></label>
                <input type="number" id="class_of" name="class_of" min="1875" max="2025" step="1"
                    placeholder="YYYY"
                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                    value="{{ $alumni->class_of }}">
            </div>
            <div class="mb-4">
