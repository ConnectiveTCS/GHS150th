...
<head>
    ...
    <meta name="description"
        content="GHS 150th celebrates a legacy of excellence and community. Join our events, discover our history, and celebrate our heritage.">

    <title>GHS 150th</title>

    {{-- Favicon --}}
    <link rel="icon" href="{{ asset('assets/GHS_Badge.png') }}" type="image/png">
